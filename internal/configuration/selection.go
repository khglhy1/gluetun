...
type ServerSelection struct {
	...
	Countries []string `json:"countries"` // Mullvad, PureVPN, PrivateVPN
	Cities    []string `json:"cities"`    // Mullvad, PureVPN, Windscribe, PrivateVPN
	Hostnames []string `json:"hostnames"` // Windscribe, Privado, PrivateVPN
